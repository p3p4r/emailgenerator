@if(!isset($download))
  	 <title>Are you a Champion?</title>
     <meta name="template" content="process-champion">
@endif
@if (Request::ajax() || isset($download) || isset($edit))
@include('dashboard.generatehtml.assets.template_header_header')
	<input name="template" type="hidden" value="process-champion">
	<input id="generalColor" name="colortmp" type="hidden" value="#ff4600">
        ...
        <tbody><tr valign="top">
            ...
            <tr>
                <td colspan="2" valign="top" width="640" style="padding-left:30px; padding-right:30px;width: 640px; ">
                    <img src="../../images/mail_generator_newsletter/header_are_you_a_champion.jpg" alt="Insider" width="580">
                </td>
            </tr></tbody>
        </table>
