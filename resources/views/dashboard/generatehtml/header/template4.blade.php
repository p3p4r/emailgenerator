        ...
        <tbody><tr valign="top">
                ...
                <tr>
                    <td colspan="2" valign="top" width="640" style="padding-left:30px; padding-right:30px;width: 640px; ">
                        ...
                        <img src="../../images/mail_generator_newsletter/header_insider.jpg" alt="Insider" width="580">
                    </td>
                </tr></tbody>
        </table>
