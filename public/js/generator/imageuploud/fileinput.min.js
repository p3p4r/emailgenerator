...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tImage = '<img id="imgPreview" width="288" height="288" style="display:block !important;" border="0" src="{data}">\n';
        ...
        var res = self.$element[0].className.replace('uploadSingle','');
        $('#img'+ res).attr('src',data);
        $('<input name="imageData" value="'+data+'" >').insertBefore('#img'+ res);
       
        $('#imageLink'+ res).removeAttr('disabled','disabled'); // Enable field
        $('#default'+ res).remove();
        ...
        _updateFileDetails: function (numFiles) {
            ...
            /* ---- Editor was here :D ---- */
            self.$container.removeClass(' file-input-ajax-new');/*self.$container.removeClass('file-input-new file-input-ajax-new');*/
