...
@endif
@if(!isset($download))
    <title>Big Title, Text & Image</title>   
@endif
...
<table width="640" style="width:640px;" cellpadding="0" cellspacing="0">  <tbody>
    ...
    <td width="352" valign="top" style="width:352px;padding-left:32px;word-break: break-all;">
                <input type="text" name="content[{{$var}}][title]" placeholder="Your text here." {!!(isset($title))? "value='$title'":''!!} style="max-width:288px;width:288px;margin:0; padding:0; color: #7e297c; font-size: 40px; font-weight:200; line-height:45px; font-family:'Calibri',Sans-serif;mso-font-alt: 'Arial';text-align:left;" >{{(isset($download))? $title.$download:''}}
